                ...
                <div class="container-fluid">
                    <div class="furniture-bottom-wrapper">
                        <div class="furniture-login">
                            <ul>
                                @guest
                                    <li>Dapatkan Akses: <a href="{{ url('login') }}">Login</a></li>
                        ...
                        <form action="{{ url('products') }}" method="GET">
                            <input placeholder="Cari yang kamu mau . . ." type="text" name="q" value="{{ isset($q) ? $q : null }}">
                            <button>
                                <i class="ti-search"></i>
                            </button>
                        </form>
                ...
                <div class="services-wrapper">
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            <h4>Pelayanan Ramah & Cepat</h4>
                            <p>Kami siap bantu kamu dengan pelayanan yang responsif dan pengiriman yang cepat, karena kepuasan kamu prioritas kami! </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            <h4>Kualitas Terbaik, Harga Terjangkau</h4>
                            <p>Setiap produk Stilo dipilih dengan teliti, mengutamakan kenyamanan dan kualitas tanpa bikin dompet menjerit. </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            <h4>Trendi & Up to Date</h4>
                            <p>Kami selalu menghadirkan koleksi fashion terbaru yang mengikuti tren terkini, biar kamu nggak ketinggalan gaya. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-about-2">
                                <p> toko fashion online yang menghadirkan beragam pilihan outfit <br> keknian, stylish dan nyaman dipakai, cocok untuk kamu yang <br> ingin tampil percaya diri di setiap kesempatan.</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Jl Pecantingan<br>Sidoarjo, Jawa Timur</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p> <a href="#"> stilo123@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            <h3 class="footer-widget-title-5">Beri Saran</h3>
                            <div class="footer-newsletter-2">
                                <p>Kirimkan email atau pembaruan berikutnya kepada kami</p>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="https://stilo.company/">Stilo</a> 2025 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
